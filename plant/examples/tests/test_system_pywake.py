...
from plant.examples.utils.yml_utils import load_yaml
from plant.examples.utils.pywake_utils import ymlSystem2PyWake
...
from plant.examples.utils.topfarm_utils import ymlSystem2TopFarm
...
def test_IEA37_case_study1_16wt_TopFarm2():
    tf = ymlSystem2TopFarm(examples_data_path + 'wind_energy_system/IEA37_case_study12_wind_energy_system.yaml')
